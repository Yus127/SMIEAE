...
Datasets : 30-min & 60-min window CSVs  (ml_ready_30min_window_enriched.csv,
                                          ml_ready_60min_window_enriched.csv)
...
OUTPUT_DIR = '/Users/YusMolina/Downloads/smieae/results/30_60_dataset/loso/model4b'
...
WINDOW_FILES = [
    ('30min', 'w30', 'enriched/ml_ready_30min_window_enriched.csv'),
    ('60min', 'w60', 'enriched/ml_ready_60min_window_enriched.csv'),
]

print("=" * 80)
print("APPROACH 4B  –  BiLSTM + MULTI-HEAD ATTENTION  |  30min & 60min WINDOWS")
...
# ─── OVERALL SUMMARY ─────────────────────────────────────────────────────────
print(f"\n\n{'='*80}")
print("OVERALL SUMMARY  |  APPROACH 4B  –  30min & 60min WINDOWS")
print(f"{'='*80}")

summary_rows = []
for wname in ['30min', '60min']:
